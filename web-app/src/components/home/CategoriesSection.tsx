...
export default function CategoriesSection({ categories, isLoading }: CategoriesSectionProps) {
    ...
    <div className="mb-16 relative">
      ...
      <div className="absolute -top-10 -right-10 w-80 h-80 opacity-5">
        <svg viewBox="0 0 320 320" fill="none" xmlns="http://www.w3.org/2000/svg">
          <polygon points="160,20 300,120 240,280 80,280 20,120" fill="url(#categoryGradient)" />
          <defs>
      ...
      <div className="text-center mb-12 relative z-10">
        <h2 className="text-4xl font-bold text-gray-900 mb-4">Banking Exam Categories</h2>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {categories.map((category: Category) => (
            <Card
              key={category._id}
              className="overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-purple-100 bg-white"
            >
